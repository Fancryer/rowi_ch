...
export const ChatClient=(props:Props)=>
{
    ...
    //                             {props.isConnected&&
    //                                 <Button style={{marginRight:7}} variant="outlined" size="small" disableElevation
    //                                         onClick={props.onPublicMessage}>Send Public Message</Button>}
    //                             {props.isConnected&&
    //                                 <Button variant="outlined" size="small" disableElevation
    //                                         onClick={props.onDisconnect}>Disconnect</Button>}
    //                             {!props.isConnected&&
    //                                 <Button variant="outlined" size="small" disableElevation
    //                                         onClick={props.onConnect}>Connect</Button>}
    //                         </Grid>
    //                     </Grid>
    //                     <div style={{
    //                         position:"absolute",
